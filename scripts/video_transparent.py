...
OUTPUT_FILE = "../output/overlay_transparent.mov"
...
def make_frame(i):
    ...
    draw.text((182, 70), text, font=font, fill=(0, 0, 0, 180))
    draw.text((180, 68), text, font=font, fill=color)

    return np.array(img)  # ⚠️ RGBA conservé
...
print("🎥 Vidéo transparente créée")